...
class EntriesViewsTest(TestCase):
    ...
    def test_entries_list_populated(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertQuerysetEqual(response.context["entry_list"], [e1, e2])
...
class EntriesCRUDTest(TestCase):
    ...
    def test_entries_create(self):
        data = {
            ...
            "form-0-id": [""],
            "form-0-date": ["2023-12-27"],
            "initial-form-0-date": ["2023-12-27", "", ""],
            "form-0-ledger": ["test1"],
            "form-0-account": ["acc1"],
            "form-0-value": ["69"],
            "form-1-id": [""],
            "form-1-DELETE": [""],
            "form-1-date": ["2023-12-27"],
            "form-1-ledger": ["test2"],
            "form-1-account": ["acc2"],
            "form-1-value": ["-60"],
            "form-2-id": [""],
            "form-2-DELETE": [""],
            "form-2-date": ["2023-12-27"],
            "form-2-ledger": ["test2"],
            "form-2-account": ["acc1"],
            "form-2-value": ["-9"],
        }
    ...
    def test_entries_create_fails(self):
        ...
        self.assertFormSetError(formset, None, None, "The rows in this entry don't sum to € 0,-. (sum = € -1)")  # type: ignore reportGeneralTypeIssues
        ...
        self.assertFormSetError(formset, None, None, "The rows in this entry don't sum to € 0,-. (sum = € 2)")  # type: ignore reportGeneralTypeIssues
    ...
    def test_entries_update(self):
        ...
        data = {
            "journal": ["journ2"],
            "notes": [""],
            "entryrow_set-TOTAL_FORMS": ["3"],
            "entryrow_set-INITIAL_FORMS": ["3"],
            "entryrow_set-MIN_NUM_FORMS": ["0"],
            "entryrow_set-MAX_NUM_FORMS": ["1000"],
            "entryrow_set-0-id": ["1"],
            "entryrow_set-0-date": ["2023-12-27"],
            "initial-entryrow_set-0-date": ["2023-12-27"],
            "entryrow_set-0-ledger": ["test1"],
            "entryrow_set-0-account": [""],
            "entryrow_set-0-value": ["1.00"],
            "entryrow_set-1-id": ["2"],
            "entryrow_set-1-date": ["2023-12-27"],
            "initial-entryrow_set-1-date": ["2023-12-27"],
            "entryrow_set-1-ledger": ["test2"],
            "entryrow_set-1-account": [""],
            "entryrow_set-1-value": ["2.00"],
            "entryrow_set-2-id": ["3"],
            "entryrow_set-2-date": ["2023-12-27"],
            "initial-entryrow_set-2-date": ["2023-12-27"],
            "entryrow_set-2-ledger": ["test1"],
            "entryrow_set-2-account": [""],
            "entryrow_set-2-value": ["-3.00"],
        }
        ...
        data = {
            ...
            "entryrow_set-0-ledger": ["test1"],
            "entryrow_set-0-account": [""],
            "entryrow_set-0-value": ["69.00"],
            "entryrow_set-1-id": ["2"],
            "entryrow_set-1-DELETE": ["on"],
            "entryrow_set-1-date": ["2023-12-27"],
            "initial-entryrow_set-1-date": ["2023-12-27"],
            "entryrow_set-1-ledger": ["test2"],
            "entryrow_set-1-account": [""],
            "entryrow_set-1-value": ["-60.00"],
            "entryrow_set-2-id": ["3"],
            "entryrow_set-2-date": ["2023-12-27"],
            "initial-entryrow_set-2-date": ["2023-12-27"],
            "entryrow_set-2-ledger": ["test1"],
            "entryrow_set-2-account": [""],
            "entryrow_set-2-value": ["-69.00"],
        }
    ...
    def test_entries_update_fails(self):
        ...
        self.assertEqual(EntryRow.objects.get(pk=1).value, 69.00)
        self.assertFormSetError(formset, None, None, "The rows in this entry don't sum to € 0,-. (sum = € 12344.00)")  # type: ignore reportGeneralTypeIssues
...
class EntryFilteredViewsTest(TestCase):
    ...
    def test_entry_by_journal(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertQuerysetEqual(response.context["entry_list"], [e1])
    ...
    def test_entry_row_by_ledger(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertQuerysetEqual(response.context["entry_row_list"], [er1])
